...
export default function HomeSection() {
  return (
      <section className="snap-section flex flex-col" id="home">
        <div
            className="container flex-1 flex flex-col justify-start gap-y-6 md:gap-y-10 overflow-visible mx-auto px-4 md:px-6 py-4">
          {/* <Reveal
          direction="up"
          delay={0}
            ...
            <div className="text-left grid gap-y-5 md:gap-y-6">
              ...
              <Reveal direction="up" delay={250}>
                <div className="flex items-center gap-2">
                  <div className="w-1 h-15 rounded-full bg-first"/>
                  <h3 className="text-sm md:text-(length:--h3-font-size) text-text font-medium">

                    <div>
                      <i className="fa-brands fa-qq text-first"></i>
                      <span className="text-first text-sm font-medium">公测群</span>
