  ...
  return (
      <section className="snap-section flex flex-col justify-center" id="about">
        <div className="container mx-auto px-5 md:px-8 py-6 md:py-0">
          <div
              className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 md:gap-16 max-w-5xl mx-auto items-end md:items-start">
              ...
              <Reveal direction="up" delay={150}>
                <div className="md:pl-20 max-w-lg">
                  ...
                  <p className="text-[13px] md:text-base text-text-light leading-relaxed">
                    <strong>中南小黑板</strong>汇集中南大学全校学习资源，提供课程评分功能，帮助同学们做出更明智的选课决策。未来将持续拓展为一站式综合校园平台。
                  </p>
                </div>
              </Reveal>
              ...
              {stats.map((stat, i) => (
                  <Reveal key={stat.label} direction="right" delay={200 + i * 120}>
                    <div className="group text-center md:text-right">
                      ...
                      />
                      <div
                          className="text-2xl md:text-5xl lg:text-6xl font-black text-title leading-none tracking-tighter">
                        {stat.value}
                      </div>
