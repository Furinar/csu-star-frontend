            ...
            <div className="flex items-center">
              {!hasHydrated ? (
                ...
                <div className="relative group p-2 cursor-pointer">
                  ...
                  />
                  <div className="absolute right-0 top-full mt-0 w-32 bg-body shadow-[0_4px_24px_rgba(0,0,0,0.15)] rounded-xl border border-[var(--nav-splitter)] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-fixed overflow-hidden flex flex-col">
                    <Link
                      href="/me"
                      onClick={handleMenuClose}
                      className="flex items-center gap-2 px-4 py-3 text-sm text-[var(--title-color)] hover:text-first hover:bg-first/5 transition-colors"
