    ...
    <div className="flex min-w-0 items-center gap-2 text-xs">
      <span
        className={`shrink-0 truncate text-gray-500 ${
          hideBarOnMobile ? "w-12 md:w-16" : "w-16"
        }`}
      >
        {label}
      </span>
      ...
      <span
        className={`shrink-0 text-right font-medium tabular-nums text-gray-600 ${
          hideBarOnMobile ? "w-8 md:w-10" : "w-10"
        }`}
      >
        {formatScore(value)}
      </span>
    ...
    >
      ...
      <div className="p-3 md:p-5 flex flex-col h-full">
        <div className="mb-2 md:mb-4 h-[44px] md:h-[52px]">
          <div className="flex items-center gap-1.5 md:gap-2 pr-12 md:pr-16">
            <h3
