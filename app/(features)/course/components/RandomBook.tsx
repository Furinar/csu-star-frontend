          ...
          <div className="left flex flex-col gap-4">
            <div className="course-info flex flex-wrap gap-4 items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <div
                    className="rounded-full border border-white/70 bg-white/75 px-3 py-1 text-xs font-medium text-slate-500 shadow-sm">
                  {countdown}s 后切换
                </div>
                <CollectButton
            ...
            <div className="course-relate flex-1 grid grid-cols-3 gap-6 pt-4">
              ...
              {/* 相关评价卡片 */}
              <div
                  className="comment-card bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between transition-transform hover:-translate-y-1">
                <div className="flex items-center gap-2 text-gray-500 mb-2">
              ...
              {/* 授课教师卡片 */}
              <div
                  className="teacher-card bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col transition-transform hover:-translate-y-1 overflow-auto">
                ...
                <div className="flex flex-wrap gap-2 overflow-y-auto w-full custom-scrollbar pr-1 content-start">
                  {course.teachers.length > 0 ? (
                      ...
                      <div
                          className="rounded-full border border-dashed border-gray-200 px-3 py-1 text-xs text-gray-400">
