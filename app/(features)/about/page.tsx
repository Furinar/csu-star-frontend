...
function LocationIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className={styles.descIcon}>
      <path d="M12 24c-.2 0-.4-.1-.6-.2C11.1 23.6 2 17.4 2 10 2 4.5 6.5 0 12 0s10 4.5 10 10c0 7.4-9.1 13.6-9.4 13.8-.2.1-.4.2-.6.2zm0-22C7.6 2 4 5.6 4 10c0 5.4 6.1 10.4 8 11.8 1.9-1.4 8-6.4 8-11.8 0-4.4-3.6-8-8-8z" />
      <path d="M12 14c-2.2 0-4-1.8-4-4s1.8-4 4-4 4 1.8 4 4-1.8 4-4 4zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" />
    </svg>
  );
}
...
function WebsiteIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className={styles.descIcon}>
      <path d="M14 16c-1.8 0-3.6-.8-4.8-2.4-.3-.4-.2-1.1.2-1.4.4-.3 1.1-.2 1.4.2 1.3 1.8 3.8 2.1 5.6.8.2-.1.3-.2.4-.4l3-3c1.5-1.6 1.5-4.1-.1-5.6-1.6-1.5-4-1.5-5.6 0l-1.7 1.7c-.4.4-1 .4-1.4 0-.4-.4-.4-1 0-1.4l1.7-1.7c2.3-2.3 6-2.3 8.3 0 2.4 2.3 2.4 6.1.1 8.5l-3 3c-.2.2-.4.4-.7.6-1.1.7-2.3 1.1-3.6 1.1z" />
      <path d="M7.1 22.9c-1.5 0-3-.6-4.2-1.7-2.4-2.3-2.4-6.1-.1-8.5l3-3c.2-.1.4-.3.6-.5 1.3-1 2.9-1.4 4.4-1.1 1.6.2 3 1.1 3.9 2.3.3.4.2 1.1-.2 1.4-.4.3-1.1.2-1.4-.2-.6-.9-1.6-1.4-2.6-1.6-1.1-.2-2.1.1-3 .8-.2.1-.3.2-.4.4l-3 3c-1.5 1.6-1.5 4.1.1 5.6 1.6 1.5 4 1.5 5.6 0l1.7-1.7c.4-.4 1-.4 1.4 0s.4 1 0 1.4l-1.7 1.7c-1.1 1.1-2.6 1.7-4.1 1.7z" />
    </svg>
  );
}
...
function EmailIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className={styles.descIcon}>
      <path d="M3 5h18a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2zm0 2v.2l9 5.4 9-5.4V7H3zm18 10V9.5l-8.5 5.1a1 1 0 0 1-1 0L3 9.5V17h18z" />
    </svg>
  );
}
...
function BioIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className={styles.descIcon}>
      <path d="M5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm0 2v14h14V5H5zm3 2h8v2H8V7zm0 4h8v2H8v-2zm0 4h5v2H8v-2z" />
    </svg>
  );
}
