...
const CORE_MEMBERS: Member[] = [
  ...
  },
  {
    ...
    title: "数据获取及清洗",
    location: "Changsha, China",
    website: "www.zonenan.pro",
    github: "https://github.com/ota-meshi",
  },
  {
    name: "GPT-5.4",
    avatar: "https://ts4.tc.mm.bing.net/th/id/OIP-C.9nB0y8FIZ156Iw0csey9NQAAAA?w=108&h=108&c=1&bgcl=1c8c09&r=0&o=7&dpr=2&pid=ImgRC&rm=3",
    title: "Slave",
  ...
  {
    name: "Opus 4.6",
    avatar: "https://tse1-mm.cn.bing.net/th/id/OIP-C.tkL5azZ9GmOlrDDWwO4mNQHaHa?w=166&h=180&c=7&r=0&o=7&dpr=2&pid=1.7&rm=3",
    title: "Slave",
    location: "San Francisco, America",
  ...
  {
    name: "Gemini -3.1-pro",
    avatar: "https://tse1-mm.cn.bing.net/th/id/OIP-C.E3H2gQjtfhGQrETciRrlPAAAAA?w=115&h=128&c=7&r=0&o=7&dpr=2&pid=1.7&rm=3",
    title: "Slave",
    location: "San Francisco, America",
  ...
  return (
      <div className={styles.member}>
        <article className={styles.teamMember}>
          {member.github ? (
              <a className={styles.githubTopRight} href={member.github} target="_blank" rel="noreferrer">
                <GithubIcon/>
              </a>
          ) : null}

          <figure className={styles.avatar}>
            <img className={styles.avatarImg} src={member.avatar} alt={`${member.name}'s Profile Picture`}/>
          </figure>
              ...
              {member.website ? (
                  <section className={styles.desc}>
                    ...
                    <p className={styles.descText}>
                      <a className={styles.descLink} href={member.website} target="_blank" rel="noreferrer">
              ...
              <div className={styles.teamGrid}>
                <div className={styles.info}>
                  ...
                  <p className={styles.lead}>
                    ...
                    of one or more core projects. They have made significant contributions to
                    the CSU Star ecosystem, with a long term commitment to the success of the
            ...
            <div className={styles.container}>
              <div className={styles.teamGrid}>
                <div className={styles.info}>
                  ...
                  <p className={styles.lead}>
                    Here we express our sincere gratitude to our sponsor members who have provided valuable support for
            ...
            <div className={styles.container}>
              <div className={styles.teamGrid}>
                <div className={styles.info}>
                  ...
                  <p className={styles.lead}>
                    Some members of the CSU Star community have so enriched it, that they deserve
                    special mention. We&apos;ve developed a more intimate relationship with these
                    key partners, often coordinating with them on upcoming features and news.
                  </p>
                </div>
                <div className={styles.members}/>
              </div>
        ...
        <footer className={styles.footer}>
          <div className={styles.footerInner}>
            <p className={styles.footerText}>
              Released under the {" "}
              <a className={styles.link} href="https://opensource.org/licenses/MIT" target="_blank" rel="noreferrer">
                MIT License
              </a>
              .
            </p>
