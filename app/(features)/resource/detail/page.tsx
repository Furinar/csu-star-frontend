...
import {DetailHero, DetailPageShell, DetailSection, EntityPillLink,} from "@/components/detail/DetailScaffold";
      ...
      <>
        <DetailPageShell>
          ...
          <DetailHero
              ...
              description={
                resource.description?.trim() ? (
                    <div className="space-y-1.5 md:space-y-2">
                      <div
                          className="text-[10px] font-semibold uppercase tracking-[0.14em] text-emerald-700/80 md:text-xs md:tracking-[0.18em]">
                        资源说明
                      </div>
              ...
              meta={
                <div
                    className="mt-3 flex flex-wrap items-center gap-x-3 gap-y-1.5 text-xs font-medium text-slate-600 md:mt-4 md:gap-4 md:text-sm">
              ...
              aside={
                <div
                    className="rounded-[18px] border border-white/80 bg-white/82 p-2.5 shadow-[0_8px_30px_rgba(15,23,42,0.04)] backdrop-blur-xl md:space-y-4 md:rounded-[20px] md:p-5">
                  <div>
                    <div className="flex items-center justify-end gap-3 md:justify-between">
                      <div className="hidden text-xs font-semibold text-slate-700 md:block md:text-sm">
                        资源互动
                      </div>
                    ...
                    <div className="mt-2 grid grid-cols-1 gap-2 md:mt-4 md:grid-cols-2 md:gap-3">
                      <button
                          ...
                          className={`inline-flex h-11 items-center justify-center rounded-[12px] border px-0 py-2 text-xs font-medium transition md:h-auto md:gap-2 md:rounded-[14px] md:px-4 md:py-2.5 md:text-sm ${
                              resource.is_liked
                      ...
                      {isDeleted ? (
                          <div
                              className="rounded-[12px] border border-rose-100 bg-rose-50 px-4 py-2 text-center text-sm font-medium text-rose-700">
                            禁止收藏
                          </div>
                      ) : (
                          <CollectButton
          ...
          {isDeleted ? (
              <div
                  className="mb-8 rounded-[20px] border border-rose-200 bg-rose-50/80 px-6 py-5 text-sm leading-7 text-rose-700 shadow-sm">
          ...
          >
            {resource.files && resource.files.length > 0 ? (
                      ...
                      >
                        <div className="flex min-w-0 flex-1 items-center gap-3 md:gap-4">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div
                                className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-[12px] text-slate-500 md:gap-x-3 md:text-[13px]">
                        ...
                        {isDeleted ? (
                            <div
                                className="inline-flex shrink-0 items-center justify-center rounded-[12px] border border-rose-200 bg-rose-50 px-4 py-2 text-sm font-medium text-rose-700">
                              已删除，禁止下载
                            </div>
                        ) : (
                            <DownloadButton
                ...
                <div
                    className="rounded-[20px] border border-dashed border-slate-200 bg-slate-50/70 py-16 text-center text-slate-500">
                  该资源暂未包含任何文件
                </div>
            )}
          </DetailSection>
          ...
          <div id="comments">
            <DetailSection
                ...
                action={
                  <div
                      className="flex w-full flex-nowrap items-center gap-2 overflow-x-auto pb-1 md:w-auto md:flex-wrap md:gap-3 md:overflow-visible md:pb-0">
            ...
            >
              ...
              {hasMore ? (
                  <div ref={loadMoreRef} className="mt-8 flex justify-center py-4">
                    {isLoadingMore ? (
                        <div
                            className="h-6 w-6 animate-spin rounded-full border-2 border-slate-200 border-t-emerald-500"/>
                    ) : (
