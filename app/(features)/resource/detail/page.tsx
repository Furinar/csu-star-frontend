    ...
    <>
      <DetailPageShell>
        ...
        <DetailHero
          ...
          aside={
            <div className="rounded-[18px] border border-white/80 bg-white/82 p-2.5 shadow-[0_8px_30px_rgba(15,23,42,0.04)] backdrop-blur-xl md:space-y-4 md:rounded-[20px] md:p-5">
              <div>
