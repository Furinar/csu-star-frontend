  ...
  return (
      <>
        ...
        <div className="flex min-h-svh items-center justify-center">
          <Stepper initialStep={1} backButtonText="Back" nextButtonText="Next" disableStepIndicators={true}>
            <Step>
                ...
                >
                  {avatarOptions.map((avatar, index) => (
                      <img
                          ...
                          src={avatar.url}
                          alt="Avatar"
                          className="h-16 w-16 rounded-full object-cover hover:-translate-y-1 cursor-pointer transition-transform duration-200 border border-transparent hover:border-(--color-first)"
                      />
                  ))}
                </div>
              </div>
